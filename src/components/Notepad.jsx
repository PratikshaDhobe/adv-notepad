...
//           <button className='btn btn-primary mx-2 px-5'>UpperCase</button>
//           <button className='btn btn-primary mx-2 px-5'>LowerCase</button>
//           <button className='btn btn-primary mx-2 px-5'>Capitalize</button>
//   </div>
//   <textarea name="" id="" rows="10" className='w-100 p-1'></textarea>
